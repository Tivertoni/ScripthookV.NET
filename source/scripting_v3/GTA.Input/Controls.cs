...
namespace GTA.Input
{
    ...
    {
        /// <summary>
        /// Gets the raw value in the range [0, 255] for the specified <see cref="ControlType"/> and <see cref="ControlAction"/>.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Returns 0.0f if the <see cref="ControlAction"/> is disabled.
        /// </remarks>
